        ...
        <div class="columns is-centered">
            ...
            <div class="column is-8-tablet is-6-desktop is-5-widescreen">
                ...
                <form @submit.prevent="registerUser" class="box">
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input type="text" v-model="state.fullName"
                                placeholder="e.g. Bob Smith" class="input"
                                :class="{ 'is-danger': v$.fullName.$error }"
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input type="text" v-model="state.email"
                                placeholder="e.g. bobsmith@gmail.com" class="input"
                    ...
                    <div class="error">
                        <span class="is-danger" v-if="store.error"> {{ store.error
                        }}</span>
                    </div>
